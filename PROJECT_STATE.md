...
**Current phase:** P14 — Professional Frontend Design and Core UI
**Active branch:** `phase/P14-frontend`  
**Current subphase:** —  
...
**Completed & merged:** P0–P13 (P13 #15 — live retrieval API + CT-CLIP worker)
