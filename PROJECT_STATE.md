...
**Current phase:** P17 — Security, Privacy and Public Repository Hardening
**Active branch:** `phase/P17-security`  
**Current subphase:** —  
...
**Completed & merged:** P0–P15 (P15 #17 — history + export). P16 dropped (AUP-005)
